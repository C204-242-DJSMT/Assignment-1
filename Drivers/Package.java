...
/*
	 ...
	 * 
	 */
	public Package(Client sender, Client addressee, String streetAddress, String postcode, String destinationCity, String status) {
		if (sender == null || streetAddress == null || postcode == null || destinationCity == null)
			throw new IllegalArgumentException();
		if(status != "Deliver" || status != "Pick up")
			throw new IllegalArgumentException();
